...
public interface Memory{
     ...
     */
    Cv addUser(Cv user) throws SQLException, JsonMappingException, JsonProcessingException;
     ...
     */
    Optional<Cv> findLoginUser(String email);
     ...
     * @return An Optional containing the Person if they exist in the db, empty otherwise.
     */
    Optional<Cv> findLoginUser(LocalDate date);
     ...
     * @return An Optional containing the Person if they exist in the db, empty otherwise.
     */
    Optional<Cv> findLoginUser(UUID id);
     ...
     * @return An Optional containing the Person if they exist in the db, empty otherwise.
     */
    Optional<Cv> findLoginUser(Long id);
