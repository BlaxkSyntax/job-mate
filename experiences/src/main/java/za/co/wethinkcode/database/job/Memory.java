...
public interface Memory{
     ...
     */
    Experience addUser(Experience user) throws SQLException, JsonMappingException, JsonProcessingException;
     ...
     */
    Optional<Experience> findLoginUser(String email);
     ...
     * @return An Optional containing the Person if they exist in the db, empty otherwise.
     */
    Optional<Experience> findLoginUser(LocalDate date);
     ...
     * @return An Optional containing the Person if they exist in the db, empty otherwise.
     */
    Optional<Experience> findLoginUser(UUID id);
     ...
     * @return An Optional containing the Person if they exist in the db, empty otherwise.
     */
    Optional<Experience> findLoginUser(Long id);
     ...
     */
    ImmutableList<Experience> findUsers();
}
