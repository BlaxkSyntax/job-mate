...
public interface Memory{
     ...
     */
    AuthenticUser addUser(Login user) throws SQLException, JsonMappingException, JsonProcessingException;
     ...
     */
    Optional<Login> findLoginUser(String email);
     ...
     * @return An Optional containing the Person if they exist in the db, empty otherwise.
     */
    Optional<Login> findLoginUser(LocalDate date);
     ...
     * @return An Optional containing the Person if they exist in the db, empty otherwise.
     */
    Optional<Login> findLoginUser(UUID id);
